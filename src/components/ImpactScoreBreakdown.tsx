...
const friendly: Record<keyof Dimensions, { name: string; icon: React.ComponentType<any>; color: string }> = {
  adventure_intensity: { name: "Adventure Intensity", icon: Zap, color: "text-orange-600" },
  social_connection: { name: "Social Connection", icon: Users, color: "text-blue-600" },
  environmental_impact: { name: "Environmental Impact", icon: Leaf, color: "text-green-600" },
  economic_impact: { name: "Economic Impact", icon: Target, color: "text-purple-600" },
  learning_growth: { name: "Learning & Growth", icon: Star, color: "text-yellow-600" },
};
