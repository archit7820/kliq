...
/**
 * Floating Interactive Info Button for badge/milestone T&C.
 */
const ProfileInfoButton: React.FC = () => (
  <BadgesInfoDialog>
    <button
      type="button"
      className="ml-1 rounded-full p-1 bg-white/90 hover:bg-green-100 border-2 border-green-200 shadow flex items-center justify-center transition
        hover:scale-105 active:scale-90 group relative"
      aria-label="Milestones and Badges Info"
      tabIndex={0}
    >
      <Info className="w-5 h-5 text-green-600 group-hover:text-yellow-600 transition" />
      {/* Fun floating dots */}
