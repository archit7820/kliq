...
-- Remove the overly permissive policy that exposes all community data to everyone
DROP POLICY IF EXISTS "View all communities" ON public.communities;

-- Create secure policies for community access
-- 1. Allow authenticated users to view public communities (limited fields)
...
-- 2. Allow community members to view their communities (full access)
